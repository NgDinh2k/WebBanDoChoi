	...
	<script type="text/javascript">
	 ...
	 window.onload = function() { 
		 ...
		 function addDatatest(data) {
		    ...
		    $.getJSON("/WebBanDoChoi/report/findNhapHang/2000-07-10/2030-07-10.htm", addDataChart2);
			$.getJSON("/WebBanDoChoi/report/findNhapHangThang/2000-07-10/2030-07-10.htm", addData2);
			$('#addbtn').click(function() {
				...
				$.getJSON("/WebBanDoChoi/report/findNhapHangThang/"+startDate+"/"+endDate+".htm", addData2);
				
				$.getJSON("/WebBanDoChoi/report/findNhapHang/"+startDate+"/"+endDate+".htm", addDataChart2);
				
				$.getJSON("/WebBanDoChoi/report/findNhapHang/"+startDate+"/"+endDate+".htm", 
		                function (data) {
		            var row = '';
				...
				$.getJSON("/WebBanDoChoi/report/findNhapHangThang/"+startDate+"/"+endDate+".htm", 
		                function (data) {
		            var row = '';
		            $.each(data, function (key, value) {
		            	row += '<tr>';
