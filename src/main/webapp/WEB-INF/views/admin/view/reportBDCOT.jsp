	...
	<script type="text/javascript">
	 ...
	 window.onload = function() { 
		 ...
		 $.ajaxSetup({
		    ...
		    $.getJSON("/WebBanDoChoi/report/findDoanhThu/2000-07-10/2030-07-10.htm", addDataChart2);
			$.getJSON("/WebBanDoChoi/report/findDoanhThu.htm", addData);
			$('#addbtn').click(function() {
				...
				$.getJSON("/WebBanDoChoi/report/findDoanhThuThang/"+startDate+"/"+endDate+".htm", addData2);
				
				$.getJSON("/WebBanDoChoi/report/findDoanhThu/"+startDate+"/"+endDate+".htm", addDataChart2);
				
				$.getJSON("/WebBanDoChoi/report/findDoanhThu/"+startDate+"/"+endDate+".htm", 
		                function (data) {
		            var row = '';
				...
				$.getJSON("/WebBanDoChoi/report/findDoanhThuThang/"+startDate+"/"+endDate+".htm", 
		                function (data) {
		            var row = '';
		            $.each(data, function (key, value) {
		            	row += '<tr>';
